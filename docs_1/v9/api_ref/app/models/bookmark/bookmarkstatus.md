...
|----------|------|-------------|
| **ACTIVE** | `string` = active | Indicates the bookmark is currently visible and accessible in the primary user collection. |
| **ARCHIVED** | `string` = archived | Indicates the bookmark has been moved to long-term storage and is hidden from the main view. |
