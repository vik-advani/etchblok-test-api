...
| **SMART** | `string` = smart | Represents a collection where items are automatically populated based on predefined filter criteria. |
...
Represents a collection that automatically includes items based on predefined filtering criteria or rules.
